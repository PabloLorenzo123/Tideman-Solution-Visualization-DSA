...
const steps = [
    ...
    return preferencias;
        ...
        description: "Esta función cuenta cuántas veces un candidato es preferido sobre otro, formando una matriz de preferencias.",
    },
    {
    ...
    return parejas;
        ...
        description: "Esta función crea y ordena las parejas de candidatos donde uno es preferido sobre otro, basado en la fuerza de la victoria.",
    },
    {
    ...
    return grafo;
        ...
        description: "Esta función bloquea las parejas más fuertes evitando ciclos para crear un grafo dirigido.",
    },
    {
    ...
    return null;
        ...
        description: "Esta función encuentra la fuente del grafo (un candidato sin aristas entrantes), quien es el ganador de la elección.",
    },
];
            ...
            <div className="row justify-content-center">
                {!showWinner ?
                    ...
                    <div className="card shadow-lg mb-4" style={{ borderRadius: '15px' }}>
                        <div className="card-header bg-primary text-white text-center fw-bold" style={{ fontSize: '1.5rem' }}>
                            Ganador
                        </div>
                        <div className="card-body text-center">
                            ...
                            {winner.photo ? (
                                ...
                                <div className="mt-3">
                                    <i className="fas fa-user-circle" style={{ fontSize: '80px', color: '#6c757d' }}></i>
                                </div>
                            )}
                        </div>
